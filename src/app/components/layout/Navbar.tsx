...
export default function Navbar() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 z-50 w-full border-b border-white/10 backdrop-blur-md bg-black/40 transition-transform duration-300 ${
    ...
    >
      ...
      {open && (
        <div className="md:hidden backdrop-blur-md bg-black/10 border-t border-white/10">
